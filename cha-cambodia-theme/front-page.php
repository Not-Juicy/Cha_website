...
<head>
  ...
  <title>Cambodian Haemophilia Association — Supporting People With Bleeding Disorders Across Cambodia</title>
  <meta name="description" content="CHA supports people living with bleeding disorders across Cambodia. Access treatment, education, care and support.">
...
[lang="km"] .hero h1 { font-size: clamp(2.2rem, 5vw, 3.8rem); line-height: 1.15; }
...
.btn-primary:hover { background: var(--c-blue-700); border-color: var(--c-blue-700); color: var(--c-white); }
...
.footer-col-brand .footer-brand { margin-bottom: var(--s-4); }
.footer-brand img {
  height: 52px;
  max-width: 200px;
  width: auto;
...
.help-card:hover {
  ...
  box-shadow: 0 20px 48px rgba(11, 29, 109, 0.15), 0 4px 12px rgba(11, 29, 109, 0.08);
}
...
.help-card:hover .icon { transform: scale(1.1) rotate(-5deg); }
.help-card .icon svg { width: 32px; height: 32px; }
.help-card .icon.icon-blue   { background: linear-gradient(135deg, #E5E8F2 0%, #D5DBED 100%); color: var(--c-blue); }
.help-card .icon.icon-red    { background: linear-gradient(135deg, #FCE5E6 0%, #F8D2D4 100%); color: var(--c-red); }
.help-card .icon.icon-purple { background: linear-gradient(135deg, #EFE6F4 0%, #E0D0EB 100%); color: var(--c-purple); }
.help-card .icon.icon-green  { background: linear-gradient(135deg, #E2F4E8 0%, #C9E8D4 100%); color: #15803D; }
.help-card h3 { font-size: 1.0625rem; margin-bottom: var(--s-2); color: var(--c-blue); }
.help-card p { color: var(--c-muted); font-size: 0.9375rem; margin-bottom: var(--s-4); }
...
.news-card .card-date .badge { margin-left: auto; }
.news-card .card-title { font-size: 1.0625rem; }
...
.history-intro { max-width: 900px; margin: 0 0 var(--s-8); text-align: left; }
.history-intro p { font-size: 1.1875rem; line-height: 1.7; color: var(--c-text); margin: 0; font-weight: 400; max-width: 75ch; }

/* Past Presidents */
.presidents-block { margin-top: var(--s-10); }
.presidents-block h3 { color: var(--c-blue); font-size: 1.25rem; font-weight: 700; margin: 0 0 var(--s-5); }
.presidents-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: var(--s-5); }
@media (max-width: 700px) { .presidents-grid { grid-template-columns: 1fr; } }
.president-card { background: var(--c-white); border: 1px solid var(--c-border); border-radius: var(--r-xl); overflow: hidden; text-align: center; transition: transform 300ms var(--ease), box-shadow 300ms var(--ease); }
.president-card:hover { transform: translateY(-6px); box-shadow: 0 24px 48px -14px rgba(11,29,109,0.22); }
.president-image { width: 100%; aspect-ratio: 1 / 1; position: relative; overflow: hidden; }
.president-image img { width: 100%; height: 100%; object-fit: cover; display: block; transition: transform 500ms var(--ease); }
.president-card:hover .president-image img { transform: scale(1.06); }
.president-image::after { content: ""; position: absolute; bottom: 0; left: 0; right: 0; height: 40%; background: linear-gradient(180deg, transparent 0%, rgba(11,29,109,0.5) 100%); pointer-events: none; }
.president-body { padding: var(--s-5) var(--s-4) var(--s-6); }
.president-role { font-size: 0.6875rem; font-weight: 700; letter-spacing: 0.14em; text-transform: uppercase; color: var(--c-blue); margin: 0 0 6px; }
.president-card h4 { font-size: 1.0625rem; font-weight: 700; color: var(--c-text); margin: 0 0 12px; letter-spacing: -0.01em; }
.president-term { display: inline-block; font-size: 0.75rem; color: var(--c-blue); background: var(--c-blue-100); padding: 5px 12px; border-radius: var(--r-full); margin: 0; font-weight: 600; letter-spacing: 0.02em; }
...
.timeline-item:hover { border-left-color: var(--c-red); }
.timeline-item::before {
  ...
  border-radius: var(--r-full);
  background: var(--c-red);
  box-shadow: 0 0 0 4px var(--c-red-100);
  transition: transform 300ms var(--ease);
}
...
.timeline-head { display: flex; align-items: center; gap: var(--s-3); margin-bottom: var(--s-3); }
.timeline-icon { width: 36px; height: 36px; border-radius: var(--r-md); display: inline-flex; align-items: center; justify-content: center; flex-shrink: 0; }
.timeline-icon svg { width: 18px; height: 18px; }
.timeline-item h3 { font-size: 1.0625rem; color: var(--c-blue); margin-bottom: var(--s-2); }
.timeline-item p { color: var(--c-muted); font-size: 0.9375rem; margin: 0; }
...
.type-card:first-child::before { background: var(--c-red); }
.type-card:last-child::before { background: var(--c-blue); }
.type-card:hover { transform: translateY(-4px); box-shadow: 0 12px 32px rgba(11, 29, 109, 0.1); border-color: var(--c-blue-100); }
.type-card .drop {
  width: 72px;
  height: 82px;
  flex-shrink: 0;
}
.type-card h3 { color: var(--c-blue); margin-bottom: var(--s-1); font-size: 1.125rem; }
.type-card p { color: var(--c-muted); margin: 0; font-size: 0.9375rem; line-height: 1.5; }
...
.membership-cta-content { padding: var(--s-8) var(--s-7); display: flex; flex-direction: column; justify-content: center; gap: var(--s-4); }
.membership-cta-content h2 { color: var(--c-blue); font-size: 1.75rem; font-weight: 800; letter-spacing: -0.02em; margin: 0; }
.membership-cta-content .lead { color: var(--c-muted); font-size: 1rem; line-height: 1.6; margin: 0; max-width: 44ch; }
.membership-cta-btns { display: flex; align-items: center; gap: var(--s-3); flex-wrap: wrap; }
.membership-cta-btns .btn-primary { display: inline-flex; align-items: center; gap: var(--s-2); background: var(--c-blue); color: var(--c-white); padding: 14px 28px; border-radius: var(--r-full); font-weight: 700; font-size: 1rem; text-decoration: none; transition: transform 200ms var(--ease), box-shadow 200ms var(--ease); box-shadow: 0 6px 20px rgba(11,29,109,0.2); }
.membership-cta-btns .btn-primary:hover { transform: translateY(-2px); box-shadow: 0 10px 28px rgba(11,29,109,0.3); color: var(--c-white); }
...
.membership-cta-links a { color: var(--c-blue); font-weight: 600; font-size: 0.875rem; text-decoration: none; transition: color 200ms var(--ease); }
.membership-cta-links a:hover { color: var(--c-red); }
.membership-cta-links .sep { color: var(--c-gray-300); }
...
.membership-cta-badge { position: absolute; bottom: 24px; left: 24px; background: rgba(11,29,109,.92); color: var(--c-white); padding: 16px 22px; border-radius: var(--r-md); backdrop-filter: blur(8px); border: 1px solid rgba(255,255,255,.15); z-index: 1; }
.membership-cta-badge strong { display: block; font-size: 1.75rem; font-weight: 700; line-height: 1; margin-bottom: 2px; }
.membership-cta-badge span { font-size: 0.8125rem; opacity: 0.9; }
@media (max-width: 900px) {
...
.impact-card:hover { transform: translateY(-6px); box-shadow: 0 16px 40px rgba(11, 29, 109, 0.1); }
.impact-card .icon {
  width: 56px;
  height: 56px;
...
.impact-card p { color: var(--c-text); font-size: 0.9375rem; margin: 0; font-weight: var(--fw-medium); }
...
.src-card.src-card-v2.red-top .src-bg { background-image: url("images/members.jpg"); }
.src-card.src-card-v2.blue-top .src-bg { background-image: url("images/family.jpg"); }
.src-card.src-card-v2.purple-top .src-bg { background-image: url("images/siem-reap-hospital.jpg"); }
...
<body>
  ...
  <header class="site-header">
    <div class="container header-inner">
      <a class="brand" href="#home"><img class="brand-logo" src="&lt;?php echo get_template_directory_uri(); ?&gt;/assets/images/cha-logo-small.png" alt="Cambodian Haemophilia Association"></a>
  ...
  <footer class="site-footer"><div class="container">
    <div class="footer-grid">
      <div class="footer-col footer-col-brand">
        <div class="footer-brand"><img src="&lt;?php echo get_template_directory_uri(); ?&gt;/assets/images/cha-logo-small.png" alt="Cambodian Haemophilia Association" style="height:52px;width:auto;max-width:200px;object-fit:contain"></div>
